            ...
            <div className='selected-performers'>
                <div className='top-performers'>
                    ...
                    {topPerformers.length ? topPerformers.map((performer) => (
                        <p style={{color: "#f0f0f0"}} className='asset-items'><span>{performer.symbol ?? performer.bankName}</span> <span style={{color: "#008000"}}>{Number(Number(performer.pnl ?? performer.profit).toFixed(1)).toLocaleString()} ({Number((((Number(performer.pnl ?? performer.profit))/Number(performer.inv ?? performer.principalAmount)) * 100).toFixed(1)).toLocaleString()}%)</span></p>
                    )) : <p>No assets found</p>}
                </div>
                ...
                <div className='worst-performers'>
                    ...
                    {worstPerformers.length? worstPerformers.map((performer) => (
                        <p style={{color: "#f0f0f0"}} className='asset-items'><span>{performer.symbol ?? performer.bankName}</span> <span style={{color: "#ff0000"}}>{Number(Number(performer.pnl ?? performer.profit).toFixed(2)).toLocaleString()} ({Number((((Number(performer.pnl ?? performer.profit))/Number(performer.inv ?? performer.principalAmount)) * 100).toFixed(1)).toLocaleString()}%)</span></p>
                    )) : <p>No assets found</p>}
                </div>
            </div>
        </div>
